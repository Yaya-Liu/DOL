...
export let counties_pop = `
  <div id="pop" style="display: none;">
    ...
    <div class="Footer">
      <div class="FootLeft">
        <p>Source: American Community Survey 5-Year Estimates (Date Last Accessed: January 28, 2022)</p>
      </div>
    </div>
    </div>
  </div>
...
export let counties_empl_edu_gend = `
  <div id="empl_edu_gend" style="display: none">
    ...
    <div class="Footer">
      <p id ="bottom part1">Note: NIL are individuals who are not in the labor force; this includes retirees and others who are not looking for work <br> <br> Source: American Community Survey 5-Year Estimates (Date Last Accessed: January 28, 2022) <br> <br>"S" Represents suppressed counts that are less than 3.</p>
    </div>
    </div>
  </div>
  `
...
export let counties_disabl_pov = `
  <div id="disabl_pov" style="display: none">
    ...
    <div class="Table">
      ...
      <div class="Footer">
        <div class="FootLeft">
          <p id="disabl_pov_chart_footer">Source: American Community Survey <span id='acsyearagg'>5</span>-Year Estimates (Date Last Accessed: January 28, 2022)</p>
        </div>
      </div>
    </div>
  </div>
...
export let counties_tanf = `
  <div id="tanf" style="display: none">
    ...
    <div class="Table">
      ...
      <div class="Footer">
        <div class="FootLeft">
          <p id="tanf_chart_footer">Source: Administrative Data from Temporary Assistance to Needy Families (TANF) and MD Wage Records (Date Last Accessed: January 28, 2022) <br><br> "--" means data is not available. </p>
        </div>
      </div>
    </div>
  </div>
...
export let counties_empl_status = `
  <div id="empl_status" style="display: none;" >
    ...
    <div class="Table">
      ...
      <div class="Footer">
        <div class="FootLeft">
          <p id="empl_status_chart_footer">The Workforce Services data is available from July 2016 to June 2017 <br><br> Source: ACS and Microdata, accessed 2/11/2022</p>
        </div>
      </div>
    </div>
  </div>
...
export let counties_snap = `
  <div id="snap" style="display: none;" >
    ...
    <div class="Table">
      ...
      <div class="Footer">
        <div class="FootLeft">
          <p id="snap_chart_footer">SNAP data is available from 2017 to 2020. <br><br> Source: Jacob France Institute, accessed 2/11/2022</p>
        </div>
      </div>
    </div>
  </div>
